...
// Set the GitVersion via -ldflags="-X 'go.bengfort.dev/ledger/pkg.GitVersion=$(git rev-parse --short HEAD)'"
var GitVersion string

// Set the BuildDate via -ldflags="-X 'go.bengfort.dev/ledger/pkg.BuildDate=YYYY-MM-DD'"
